...
var table = $('#tableResult').DataTable({
    ...
    buttons : [{
        extend: 'excel',
        title: 'resultado_de_analisis_anexo2.xlsx',
...
function renderData(i, value, classes, saveData = []) {
    ...
    $.each(value, function(key, value) {
        ...
        saveData[a] = {'curso' : value.curso, 'instancia' : value.instancia, 'usuario' : value.usuario, 'rol' : value.rol, 'institucion_id' : value.institucion_id};
        i++;
        a++;
    });
}